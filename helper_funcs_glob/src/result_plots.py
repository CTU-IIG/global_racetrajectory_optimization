...
def result_plots(plot_opts: dict,
    ...
    if plot_opts["raceline"]:
        ...
        plt.savefig("outputs/raceline_plot.png") #show()
    ...
    if plot_opts["raceline_curv"]:
        ...
        plt.savefig("outputs/raceline_curv_plot.png") #show()
    ...
    if plot_opts["racetraj_vel_3d"]:
        ...
        plt.savefig("outputs/raceline_vel_3d_plot.png") #show()
    ...
    if plot_opts["spline_normals"]:
        ...
        plt.savefig("outputs/spline_normals_plot.png") #show()
